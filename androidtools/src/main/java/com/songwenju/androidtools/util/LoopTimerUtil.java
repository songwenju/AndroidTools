...
public class LoopTimerUtil {
	 ...
	 */
	public LoopTimerUtil(Handler handler, Runnable runnable, int intervalMillis) {
	 ...
	 * @param intervalMillis
	 */
	public LoopTimerUtil(Runnable runnable, int intervalMillis) {
