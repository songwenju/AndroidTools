...
public class DoubleClickUtil {
	 ...
	 */
	public DoubleClickUtil(Context context, String hintMessage, int effectiveIntervalTime) {
	 ...
	 */
	public DoubleClickUtil(Context context, String hintContent) {
	 ...
	 * @param context Android上下文
	 */
	public DoubleClickUtil(Context context) {
