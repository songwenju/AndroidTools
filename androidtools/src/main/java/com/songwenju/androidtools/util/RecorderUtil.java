...
public class RecorderUtil {
	...
	public void playingFinish(){
		Log.i("spoort_list", "RecorderUtil 播放结束释放资源");
		if(playState){
			playState = false;
		}
		mPlayer.release();
	...
	public boolean stopPlaying(){
		...
		if(mPlayer!=null){
			...
			Log.i("spoort_list", "RecorderUtil mPlayer.stop()");
			mPlayer.stop();
			mPlayer.release();
			mPlayer = null;
			playState = false;
			...
			Log.i("spoort_list", "RecorderUtil mPlayer.stop() is null");
			return false;
		}
	}
	//当文件播放结束后调用此方法
	...
	////				playState = false;
	////			}
	//			Log.i("spoort_list", "RecorderUtil 播放结束");
	//			mPlayer.release();
	//			mPlayer = null;
	//		}
	//	};
